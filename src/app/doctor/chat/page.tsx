...
import { 
  Send, Paperclip, MoreVertical, Phone, Video, CheckCheck, Search, Smile, Mic,
  Shield, ChevronRight, Activity, FileText, Pill, Calendar, Clock,
  User, Star, AlertCircle, Plus, Image as ImageIcon, X
} from 'lucide-react';
  ...
  return (
    <div style={{ height: 'calc(100vh - 152px)', margin: '0 -40px -80px', display: 'flex', overflow: 'hidden', borderTop: '1px solid var(--border)' }}>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
        ...
        {/* Messages */}
        <div ref={scrollRef} style={{ flex: 1, overflowY: 'auto', padding: '20px 60px', background: '#EFEAE2', display: 'flex', flexDirection: 'column', gap: 4 }}>
      ...
      {showProfile && (
        <div style={{ width: 320, background: 'white', borderLeft: '1px solid #E9EDEF', display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
          ...
          <div style={{ padding: '16px 20px', marginTop: 'auto' }}>
            <Link href="/doctor/patients" className="btn btn-secondary" style={{ width: '100%', display: 'flex', justifyContent: 'center', textDecoration: 'none', fontSize: 13 }}>View Full Patient Profile</Link>
          </div>
        </div>
      )}
    </div>
