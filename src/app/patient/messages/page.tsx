    ...
    <div style={{ 
      ...
      <div style={{ 
        ...
        <div style={{ padding: '16px', background: '#F0F2F5', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div style={{ width: 40, height: 40, borderRadius: '50%', background: 'var(--accent)', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontWeight: 700 }}>VP</div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', position: 'relative' }}>
        {/* Chat Area Header */}
        <div style={{ padding: '10px 16px', background: '#F0F2F5', borderLeft: '1px solid #E9EDEF', display: 'flex', alignItems: 'center', justifyContent: 'space-between', zUnit: 10 }}>
